...
export const sourceRegistry: SourceRecord[] = [
  ...
  { id: 'palantir-blog', name: 'Palantir Blog', homepage: 'https://blog.palantir.com/', feedUrl: 'https://blog.palantir.com/feed', fetchMode: 'rss', language: 'en', country: 'GLOBAL', kind: 'official', contentType: 'blog', defaultPillar: 'Organization', sourceTier: 1, weight: 100, minScore: 50, priority: 98, pollIntervalMinutes: 360, backfillPages: 1, backfillMode: 'feed-window' },
  ...
  { id: 'digital-agency-jp', name: 'デジタル庁', homepage: 'https://www.digital.go.jp/news', feedUrl: 'https://www.digital.go.jp/rss/news.xml', fetchMode: 'rss', language: 'ja', country: 'JP', kind: 'government', contentType: 'news', defaultPillar: 'Japan', sourceTier: 1, weight: 98, minScore: 42, priority: 98, pollIntervalMinutes: 360, backfillPages: 1, backfillMode: 'feed-window' },
